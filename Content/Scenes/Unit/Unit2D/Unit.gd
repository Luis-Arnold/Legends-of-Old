...
const soldierScene = preload('res://Content/Scenes/Soldier/2D/Soldier.tscn')
...
func _ready():
	...
	relativeFormationPositions = UnitUtil.matchFormationType(UnitUtil.formationType.RECTANGLE, troopSize, 10)
